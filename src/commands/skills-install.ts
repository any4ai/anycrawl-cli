/**
 * Skills install - builds args for npx skills add
 * Uses any4ai/anycrawl-cli GitHub repo
 */

const SKILLS_REPO = 'any4ai/anycrawl-cli';
...
export function buildSkillsInstallArgs(
  ...
  args.push('skills', 'add', SKILLS_REPO, '--full-depth');
